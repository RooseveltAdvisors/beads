...
func TestCreateBlockedDuringMigrationFreeze(t *testing.T) {
	...
	stdout, stderr, code := runBDFrozen(t, bd, dir, "create", "--due", "+7d", "should not be created", "-p", "2")
...
func TestAutoMigrateSkippedDuringMigrationFreeze(t *testing.T) {
	tests := []struct {
		...
		{name: "create", args: []string{"create", "--due", "+7d", "should not be created", "-p", "2"}, wantExit: ExitMigrationFrozen, wantBlocked: true},
