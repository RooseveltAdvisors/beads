...
#   BD_DUE_SWEEP_PUBLISH    command receiving the summary as $1. Optional: with
#                           no publisher the sweep still runs and the summary
#                           goes to stdout, which the journal keeps.
set -euo pipefail
